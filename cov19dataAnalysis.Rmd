...
covCounties <- read_csv("./covid-19-data/us-counties.csv", col_types = "Dccnnn")

covStates <- read_csv("./covid-19-data/us-states.csv", col_types = "Dcnnn")
